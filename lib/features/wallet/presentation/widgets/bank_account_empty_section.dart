// features/wallet/presentation/widgets/bank_account_empty_section.dart
  ...
  void _showAddAccountSheet(BuildContext context) {
    showModalBottomSheet(
      ...
      builder: (_) => Stack(
        ...
        children: [
          AddBankAccountBottomSheet(onSuccess: () {}),
          Positioned(
            top: 0,
            child: Container(
              width: 56,
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text(
          'محفظتك غير مربوطة بحساب بنكي',
          style: AppTextStyle.headline1,
          textAlign: TextAlign.center,
        ),
        const SizedBox(height: 8),
        const Text(
          'قم بإضافة بيانات حسابك البنكي لربطه بمحفظتك الإلكترونية وبدأ الدفع منه',
          textAlign: TextAlign.center,
